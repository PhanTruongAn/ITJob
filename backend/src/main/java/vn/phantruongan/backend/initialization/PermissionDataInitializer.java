...
// import
// vn.phantruongan.backend.authorization.repositories.PermissionRepository;
...
// // 5. DELETE - DELETE xóa
// addIfNotExists(toSave, resource, ActionEnum.DELETE, MethodEnum.DELETE, base +
// "/{id}");
// }
...
// private void addIfNotExists(List<Permission> list, ResourceEnum resource,
// ActionEnum action,
// MethodEnum method, String apiPath) {
// if
// (permissionRepository.existsByResourceAndActionAndMethodAndApiPath(resource,
// action, method, apiPath)) {
// return;
// }
